...
Todo el desarrollo de un juego es en un laberinto. Sin embargo no es un laberinto vacío lleno de pasillos delgados y oscuros, sino que está pensado como una serie de habitaciones interconectadas entre sí.

Una habitación es el sitio donde ocurren todos los eventos que se pueden encontrar en el juego. Está representado con una imagen y una serie de acciones que puede realizar un jugador dentro de ella.

Una habitación es donde el jugador va a tener mayor libertad de movimientos, porque es el lugar donde se ejecutan cadenas de eventos.
