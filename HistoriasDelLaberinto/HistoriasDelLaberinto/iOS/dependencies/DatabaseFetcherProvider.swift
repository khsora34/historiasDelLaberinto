class DatabaseFetcherProvider {
    ...
    init(eventsFetcherManager: EventFetcherManager, itemsFetcher: ItemFetcher, charactersFetcher: CharacterFetcher, roomsFetcher: RoomFetcher, movementFetcher: MovementFetcher) {
