...
class ExampleScenePresenter: BasePresenter {
    ...
    var room: Room = Room(id: "", name: "", description: "", imageUrl: "", imageSource: .local(""), actions: [])
...
extension ExampleScenePresenter: ExampleScenePresentationLogic {
    func navigateToNewPlace() {
        router?.goToNewView(room: Room(id: "23", name: "Hola", description: "Si", imageUrl: "", imageSource: .local(""), isGenericRoom: true, actions: []))
    }
